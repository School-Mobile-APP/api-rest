...
public class SgPersona implements Serializable {
	 ...
	 * 
	 * @ManyToOne private SgEtnia perEtnia;
	 * 
	 * @JoinColumn(name = "per_estado_civil_fk", referencedColumnName = "eci_pk")
	 * 
	 * @ManyToOne private SgEstadoCivil perEstadoCivil;
	 * 
	 * @JoinColumn(name = "per_sexo_fk", referencedColumnName = "sex_pk")
	 * 
	 * @ManyToOne
	 * 
	 * @IndexedEmbedded(includeEmbeddedObjectId = true) private SgSexo perSexo;
	 * 
	 ...
	 * 
	 * @OneToOne(cascade = CascadeType.ALL) private SgDireccion perDireccion;
	 * 
	 * @OneToOne(mappedBy = "estPersona") private SgEstudiante perEstudiante;
	 * //TODO: ver de borrar esta relacion o hacer lazy para que el merge no la
	 * levante en memoria. Para que sea lazy no puede ser mappedBy.
	 * 
	 * @OneToMany(cascade = CascadeType.ALL, mappedBy = "telPersona", orphanRemoval
	 * = true) private List<SgTelefono> perTelefonos;
	 * 
	 ...
	 * 
	 * @ManyToOne private SgDepartamento perPartidaDepartamento;
	 * 
	 * @JoinColumn(name = "per_partida_municipio_fk")
	 * 
	 * @ManyToOne private SgMunicipio perPartidaMunicipio;
	 * 
	 * @JoinColumn(name = "per_departamento_nacimiento_fk")
	 * 
	 * @ManyToOne
	 * 
	 * @IndexedEmbedded(includeEmbeddedObjectId = true) private SgDepartamento
	 * perDepartamentoNacimento;
	 * 
	 * @JoinColumn(name = "per_municipio_nacimiento_fk")
	 * 
	 * @ManyToOne
	 * 
	 * @IndexedEmbedded(includeEmbeddedObjectId = true) private SgMunicipio
	 * perMunicipioNacimiento;
	 * 
	 ...
	 * 
	 * @ManyToOne private SgNacionalidad perNacionalidad;
	 * 
	 * @Fetch(FetchMode.SUBSELECT)
	 * 
	 * @ManyToMany(fetch = FetchType.LAZY)
	 * 
	 * @JoinTable( name = "sg_personas_discapacidades", schema =
	 * Constantes.SCHEMA_CENTRO_EDUCATIVO, joinColumns = @JoinColumn(name =
	 * "per_pk"), inverseJoinColumns = @JoinColumn(name = "dis_pk")) private
	 * List<SgDiscapacidad> perDiscapacidades;
	 */
	/*
	 * @Fetch(FetchMode.SUBSELECT)
	 * 
	 * @ManyToMany(fetch = FetchType.LAZY)
	 * 
	 * @JoinTable( name = "sg_personas_trastornos_aprendizaje", // schema =
	 * Constantes.SCHEMA_CENTRO_EDUCATIVO, joinColumns = @JoinColumn(name =
	 * "per_pk"), inverseJoinColumns = @JoinColumn(name = "tra_pk")) private
	 * List<SgTrastornoAprendizaje> perTrastornosAprendizaje;
	 */

	/*
	 * @OneToMany(mappedBy = "allPersonaReferenciada") private List<SgAllegado>
	 * perAllegados;
	 * 
	 * @ManyToOne
	 * 
	 * @JoinColumn(name = "per_profesion_fk") private SgProfesion perProfesion;
	 * 
	 * @JoinColumn(name = "per_ocupacion_fk")
	 * 
	 * @ManyToOne private SgOcupacion perOcupacion;
	 * 
	 * @ManyToOne
	 * 
	 * @JoinColumn(name = "per_escolaridad_fk") private SgEscolaridad
	 * perEscolaridad;
	 */
	 ...
	 * 
	 * @ManyToOne private SgTipoTrabajo perTipoTrabajo;
	 */
...
//    private SgTipoServicioSanitario perTipoServicioSanitario; //Se movió a datos residenciales. Luego borrar columna
   ...
   // private EnumEstadoPersona perEstado;
	 ...
	 * @ManyToMany(fetch = FetchType.LAZY)
	 * 
	 * @JoinTable( name = "sg_personas_terapias", schema =
	 * Constantes.SCHEMA_CENTRO_EDUCATIVO, joinColumns = @JoinColumn(name =
	 * "per_pk"), inverseJoinColumns = @JoinColumn(name = "ter_pk")) private
	 * List<SgTerapia> perTerapias;
	 * 
	 * @Fetch(FetchMode.SUBSELECT)
	 * 
	 * @ManyToMany(fetch = FetchType.LAZY)
	 * 
	 * @JoinTable( name = "sg_personas_referencias_apoyo", schema =
	 * Constantes.SCHEMA_CENTRO_EDUCATIVO, joinColumns = @JoinColumn(name =
	 * "per_pk"), inverseJoinColumns = @JoinColumn(name = "rea_pk")) private
	 * List<SgReferenciasApoyo> perReferenciasApoyo;
	 * 
	 * @JoinColumn(name = "per_pk", insertable = false, updatable = false)
	 * 
	 * @LazyToOne(LazyToOneOption.NO_PROXY)
	 * 
	 * @OneToOne(fetch = FetchType.LAZY, optional = false) private
	 * SgDatosResidencialesPersona perDatosResidenciales;
	 */
